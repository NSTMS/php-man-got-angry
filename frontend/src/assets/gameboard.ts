...
const game_path = [
  44,55,66,67,68,69,70,81,92,103,114,115,116,105,94,83,72,73,74,75,76,65,54,53,52,51,50,39,28,17,6,5,4,15,26,37,48,47,46,45
]


// const game_path = [
//   44, 45, 46, 47, 48, 37, 26, 15, 4, 5, 6, 17, 28, 39, 50, 51, 52, 53, 54, 65,
//   76, 75, 74, 73, 72, 83, 94, 105, 116, 115, 114, 103, 92, 81, 70, 69, 68, 67,
//   66, 55,
// ];
...
export const gameboard: Tile[][] = [
  ...
  [
    ...
    { background_color: '', blinking: false, role: 'dice', type: 'blank' }, // środek układu
    {
